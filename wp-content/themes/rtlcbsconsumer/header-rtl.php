				...
				<nav class="navbar navbar-inverse">
					<div class="container">					
						<div class="navbar-header">
							<a href="<?php bloginfo( 'url' ) ?>?channel=entertainment" class="navbar-brand visible-xs logo-entertainment"><img src="<?php echo get_template_directory_uri().'/images/ENT-New.png'; ?>" alt="<?php bloginfo( 'name' ) ?> Logo"/></a>

							<a href="<?php bloginfo( 'url' ) ?>?channel=extreme" class="navbar-brand visible-xs logo-extreme"><img src="<?php echo get_template_directory_uri().'/images/EXT-New.png'; ?>" alt="<?php bloginfo( 'name' ) ?> Logo" class="img-disabled"/></a>
