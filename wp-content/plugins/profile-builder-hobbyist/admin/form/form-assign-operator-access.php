...
<div id="message" class="updated notice is-dismissible hidden" >
...
<form id="form_operator_access" method="post">
	<table class="form-table">
		<tbody>
			...
			<tr>
				<th scope="row"><label ><h2>Select Operator</h2></label></th>
			</tr>
			...
			<tr>
				<th scope="row"><label ><h2>Assign Access</h2></label></th>
			</tr>
			<tr>
