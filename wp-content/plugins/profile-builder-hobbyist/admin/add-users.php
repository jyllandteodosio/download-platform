...
function wppb_add_new_user_submenu_page() {
	add_submenu_page( 'profile-builder', __( 'Add User', 'profile-builder' ), __( 'Add User', 'profile-builder' ), 'manage_options', 'profile-builder-add-user', 'wppb_add_user_content' );
}
