...
function wppb_hobbyist_plugin_init() {
    if (function_exists('wppb_return_bytes')) {
        ...
        // custom added field - to support profile builder in admin page
        ...
        if (file_exists(WPPB_PLUGIN_DIR . '/admin/edit-users.php')){
            include_once(WPPB_PLUGIN_DIR . '/admin/edit-users.php');
        }
