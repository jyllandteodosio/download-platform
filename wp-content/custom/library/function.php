...
/* Email Notice */
add_action( 'pre_post_update', 'wpse41912_save_post' );
function wpse41912_save_post($id)
{
...
// function wpse46583_save( $data , $postarr ) {
//      print_r($data);
// }
// add_action('wp_insert_post_data','wpse46583_save' );
