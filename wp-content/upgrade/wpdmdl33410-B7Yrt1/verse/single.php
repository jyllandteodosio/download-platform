                    ...
                    <div  <?php post_class('post'); ?>>
                        ...
                        <div class="post-meta">
                            <ul class="meta-list">
                                ...
                                <li class="post-navs">
                                    <span
                                        class="text-primary"><?php previous_post_link('%link', '<i class="fa fa-long-arrow-left"></i> ' . __('Previous', 'thenext')); ?></span>
                                    <i class="fa fa-dot-circle-o"></i>
                                    <span><?php next_post_link('%link', __('Next', 'thenext') . ' <i class="fa fa-long-arrow-right"></i>'); ?></span>
                                </li>
                            </ul>
                        ...
                        <h3 class="widget-heading"><?php _e('Post Tags', 'thenext'); ?></h3>
                        ...
                        <h3 class="widget-heading"><?php _e('About The Author', 'thenext'); ?></h3>
                        ...
                        <div class="post-author-info">
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <span class="txt author-name theme-color">
