...
class TheNextPreLoader{
    ...
    function  __construct(){
        ...
        add_action(THEME_PREFIX."body_content_before", array($this, 'BeforeBodyContent'));
        add_action(THEME_PREFIX."body_content_after", array($this, 'AfterBodyContent'));
    ...
    function BeforeBodyContent(){
        ...
        <style>
            ...
            .signal {
                border:3px solid <?php echo WPEdenThemeEngine::GetOption('color_scheme', '#2C3E50') ?>;
                border-radius:30px;
                height:30px;
                left:50%;
