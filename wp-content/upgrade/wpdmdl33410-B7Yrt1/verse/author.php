...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-3 col-sm-4">
            ...
            <div class="panel panel-theme panel-author">
                <div class="panel-heading"><?php _e('About','thenext');?></div>
            ...
            <div class="panel panel-theme panel-author">
                <div class="panel-heading"><?php _e('Contact Author','thenext');?></div>
                <div class="panel-body">
                    <form method="post">
                        <input type="hidden" name="task" value="contact_author" />
                        <input type="hidden" name="uid" value="<?php echo $curauth->ID;?>" />

                        <label><?php _e('Your Name:', 'thenext'); ?></label>
                        <input type="text"  name="name" class="form-control" />
                        <label><?php _e('Your Email:', 'thenext'); ?></label>
                        <input type="text"  name="email" class="form-control"/>                           
                        <label><?php _e('Subject:', 'thenext'); ?></label>
                        <input type="text"  name="subject" class="form-control"/>                           
                        <label><?php _e('Message:', 'thenext'); ?></label>
                        <textarea class="form-control" name="message"></textarea>                            
                        <button class="btn btn-info"><?php _e('Submit', 'thenext'); ?></button>
                    </form>
                </div>
            </div>
        </div>
