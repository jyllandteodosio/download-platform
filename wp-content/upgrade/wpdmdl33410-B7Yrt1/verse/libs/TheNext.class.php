...
class TheNext
{
    ...
    function Actions()
    {
        ...
        add_action('wp_enqueue_scripts', array($this, 'EnqueueScripts'), 9999999);
    ...
    function EnqueueScripts()
    {
        ...
        wp_enqueue_style('thenext-bootstrap', get_template_directory_uri() . '/bootstrap/css/bootstrap.css');
        ...
        wp_enqueue_style('thenext-animate', get_template_directory_uri() . '/css/animate.min.css');
        wp_enqueue_style('thenext-font-awesome', get_template_directory_uri() . '/fonts/font-awesome-4.3.0/css/font-awesome.min.css');
        wp_enqueue_style('thenext-font-tn', get_template_directory_uri() . '/fonts/icons/icons.css');

        wp_enqueue_script('thenext-less', get_template_directory_uri() . '/js/less.js', array('jquery'));
        wp_enqueue_script('thenext-bootstrap', get_template_directory_uri() . '/bootstrap/js/bootstrap.min.js', array('jquery'));
        wp_enqueue_script('thenext-wow', get_template_directory_uri() . '/js/wow.min.js', array('jquery'));
        wp_enqueue_script('thenext-sticky', get_template_directory_uri() . '/js/jquery.sticky.js', array('jquery'));
    ...
    function LessVars()
    {
        ...
        <script type="text/javascript">
            less.modifyVars({
                '@color': '<?php echo WPEdenThemeEngine::GetOption('color_scheme','#2C3E50'); ?>',
                '@acolor': '<?php echo WPEdenThemeEngine::GetOption('a_color','#2C3E50'); ?>',
                '@ahcolor': '<?php echo WPEdenThemeEngine::GetOption('ah_color','#2C3E50'); ?>',
                '@nvhcolor': '<?php echo WPEdenThemeEngine::GetOption('menuh_color','#3399ff'); ?>',
                '@rgbcolor': '<?php echo Util::HEX2RGB(WPEdenThemeEngine::GetOption('color_scheme','#3399ff')); ?>'
            });
        </script>
        <?php
    }
