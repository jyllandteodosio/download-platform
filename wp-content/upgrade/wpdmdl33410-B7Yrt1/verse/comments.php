<div id="comments">
    <?php if (post_password_required()) : ?>
        <p class="nopassword"><?php _e('This post is password protected. Enter the password to view any comments.','thenext'); ?></p>
</div>
    <?php
    return;
    endif;
...
<?php if (have_comments()) : ?>
    <h3 class="widget-heading"> <?php _e('Discussion','thenext');?></h3>
    ...
    ?>
    <p class="nocomments"><?php _e('Comments are closed.','thenext'); ?></p>
    <?php endif; ?>
