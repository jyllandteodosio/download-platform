...
$posts = get_posts(array(
        'post_type' => 'wpdmpro',
        'showposts' => WPEdenThemeEngine::GetOption('home_slide_count', 3),
        'tax_query' => array(
            array(
                'taxonomy' => 'wpdmcategory',
                'terms' => WPEdenThemeEngine::GetOption('home_slider_category'),
                'field' => 'term_id',
                        ...
                        <?php foreach ($posts as $post) { ?>
                            <div class="item <?php echo $first++ == 1 ? 'active' : ''; ?>" id="slide-<?php echo $first; ?>">
                                ...
                                <div class="carousel-caption">
                                    ...
                                    <h2 class="slide-title inv"  data-animation="animated fadeInUp" data-duration="2s" data-delay="1s"><?php echo $post->post_title; ?></h2>
                                    ...
                                    <div class="meta">
                                        <a href="<?php echo get_permalink($post->ID);?>" class="btn btn-primary inv slide-btn"  data-animation="animated fadeInUp" data-delay="3s" data-duration="2s"><?php _e('Download','thenext');?> <i class="tn-download"></i></a>
                                    </div>
